class AutoEncoder(tf.keras.Model):
    ...
    def build_decoder(self):
        ...
        decoded = layers.Dense(self.data_dim, activation='tanh')(x)
    ...
    def find_anomalies(self, inputs, data, alpha=2):
        reconstructed_data = self(inputs) # Reconstruct the data using the model
        ...
        data_sorted.to_csv('ae_results.csv')
